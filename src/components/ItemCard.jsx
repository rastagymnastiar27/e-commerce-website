...
const ItemCard = ({ item }) => {
  return (
    <div
      className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-y-14 gap-x-8 
      place-items-center"
    >
      {/* Card Section */}
      {item.map((item) => (
        <div
          ...
          className="group shadow-[0_0_10px_1px_rgba(0,0,0,0.3)] rounded-lg bg-gradient-to-br 
        ...
        >
          <div className="relative overflow-hidden">
            <img
              src={item.img}
              alt={item.title}
              className="lg:h-[200px] lg:w-[300px] object-cover rounded-t-lg 
